---
title: 'Penguin Login - LACTF 2024'
date: 2024-02-18T22:20:00+02:00
tags:
- writeup
- CTFs
- lactf-2024
...
![website home page](/writeups/lactf-2024/penguin-login/img/website.png)
...
![code 200 example](/writeups/lactf-2024/penguin-login/vid/code200.gif)

![code 201 example](/writeups/lactf-2024/penguin-login/vid/code201.gif)
...
![First injection test](/writeups/lactf-2024/penguin-login/vid/injTest.gif)
...
![Example of the just presented "technique"](/writeups/lactf-2024/penguin-login/vid/PlayTest.gif)
...
![Example of using OneCompiler to verify the result of an unconventional query](/writeups/lactf-2024/penguin-login/img/OnlineExample.png)
...
![Execution of the final script](/writeups/lactf-2024/penguin-login/vid/FinalPayload.gif)

`lactf{90stgr35_3s_n0t_l7k3_th3_0th3r_dbs_0w0}`

![Extract from an interesting conversation had in a ticket](/writeups/lactf-2024/penguin-login/img/InterestingTicket.png)
